...
import 'package:flutter_cvmaker/purchare_in_app_page.dart';
...
class _HomePageState extends State<HomePage> {
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(border: Border.all(width: 1), borderRadius: const BorderRadius.all(Radius.circular(6)), color: Colors.amber),
          child:  Row(children: [
          Text("$coinNumber", style: const TextStyle(fontSize: 12),),
            ...
            : SpeedDial(
                ...
                speedDialChildren: <SpeedDialChild>[
                  ...
                  SpeedDialChild(
                    ...
                    foregroundColor: buttonText,
                    backgroundColor: button1,
                    label: 'Thông tin cá nhân (2 điểm)',
                    onPressed: () {
                      setState(() {
  ...
  void paid2Coin() async{
    if (coinNumber < 2) {
      Fluttertoast.showToast(msg: "Không đủ điểm! vui lòng nạp thêm");
      return ;
    }
    SharedPreferences prefs = await SharedPreferences.getInstance();
    coinNumber = coinNumber - 2;
    await prefs.setInt("coin", coinNumber);
  }

  void navigateCoint(BuildContext context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => const PurchareInAppPage()));
  }
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          errorText: errorPhone, labelText: 'Điện thoại'),
                    ),
                    TextFormField(
                    ...
                    TextFormField(
                      ...
                      maxLength: 30,
                      decoration: InputDecoration(
                          errorText: errorAddress, labelText: 'Địa chỉ'),
                    ),
                  ],
                ),
              ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (phoneInputController.text.isEmpty) {
                      ...
                      stfSetState(() {
                        errorEmail = 'Nhập địa chỉ email';
                      });
                    } else if (addressInputController.text.isEmpty) {
                      stfSetState(() {
                        errorAddress = 'Nhập địa chỉ';
                      });
                    } else {
                      setState(() {
                        paid2Coin();
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      maxLength: 30,
                      decoration: InputDecoration(
                          errorText: errorFirstname, labelText: 'Tên'),
                    ),
                    TextFormField(
                      controller: lastnameInputController,
                      maxLength: 30,
                      decoration: InputDecoration(
                          errorText: errorLastname, labelText: 'Họ'),
                    ),
                    TextFormField(
                      controller: positionInputController,
                      maxLength: 30,
                      decoration: InputDecoration(
                          errorText: errorPosition, labelText: 'Vị trí'),
                    ),
                    TextFormField(
                      ...
                      maxLines: 5,
                      decoration: InputDecoration(
                          errorText: errorProfile, labelText: 'Thông tin cá nhân'),
                    ),
                    TextFormField(
                      controller: birthdateInputController,
                      maxLength: 30,
                      decoration: InputDecoration(
                          errorText: errorBithdate, labelText: 'Ngày sinh'),
                    ),
                    TextFormField(
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'Giải thưởng thứ 1'),
                    ),
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'Giải thưởng thứ 2'),
                    ),
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'Giải thưởng thứ 3'),
                    ),
                  ],
                ),
              ),
        ...
        builder: (dialogContext) {
          return StatefulBuilder(builder: (stfContext, stfSetState) {
            return AlertDialog(
              ...
              scrollable: true,
              title: const Text(
                'Nhập thông tin đào tạo của bạn',
              ),
              content: Container(
                padding: const EdgeInsets.all(0),
                alignment: Alignment.center,
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'Năm 1', errorText: errorEdu1Year),
                          ),
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'Chuyên ngành', errorText: errorEdu1Major),
                          ),
                          TextFormField(
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Năm 2'),
                          ),
                          TextFormField(
                          ...
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Ngành'),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Năm 3'),
                          ),
                          TextFormField(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (edu1YearInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1Year = 'Nhập số năm học';
                      });
                    } else if (edu1MajorInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1Major = 'Nhập chuyên ngành';
                      });
                    } else if (edu1SchoolInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1School = 'Nhập ngành học';
                      });
                    } else {
                      setState(() {
                        paid2Coin();
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Công ty'),
                          ),
                          TextFormField(
                            ...
                            maxLines: 2,
                            decoration:
                                const InputDecoration(labelText: 'Chi tiết'),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Năm 4'),
                          ),
                          TextFormField(
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Năm 5'),
                          ),
                          TextFormField(
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Tên kỹ năng'),
                          ),
                          TextFormField(
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'Tên ngôn ngữ'),
                          ),
                          Row(
                            children: [
                              Expanded(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (language1TitleInputController.text.isEmpty) {
                      stfSetState(() {
                        errorLanguage1Title = 'Vui lòng nhập tên ngôn ngữ';
                      });
                    } else {
                      setState(() {
                        paid2Coin();
  ...
  void saveAll() async {
    ...
    SnackbarWidget.show(context, text: 'Lưu thành công!');
  }
  ...
  void loadData() async {
    ...
    setState(() {
      ...
      int? coinNumberX = prefs.getInt('coin');
      if (coinNumberX != null) {
        coinNumber = coinNumberX;
      }
      else {
        coinNumber = 30;
      }
